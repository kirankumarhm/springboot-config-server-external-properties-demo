 ...
 * the clients cannot tell them apart. Spring Cloud Bus then normalises it: {@code
 * PathDestinationFactory} appends {@code ":**"} to any destination containing at most one colon, so
 * {@code inventory-service} becomes {@code inventory-service:**} and targets every instance. That
 * normalisation is also why a prefix like {@code inventory} does NOT reach {@code
 * inventory-service}.
 */
@Component
