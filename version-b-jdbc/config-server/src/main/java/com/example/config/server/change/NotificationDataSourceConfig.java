 ...
 *
 * <p>{@link PostgresNotifyChangeDetector} now opens one raw {@code DriverManager} connection
 * instead. That is a better fit regardless: the requirement is exactly one dedicated physical
 * connection held for the process lifetime, which is the opposite of what a pool is for.
 */
@Configuration
@EnableScheduling
