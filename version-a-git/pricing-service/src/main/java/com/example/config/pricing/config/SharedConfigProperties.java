 ...
 * shared file.
 *
 * <p>Setter-based JavaBean binding, deliberately. See {@code PricingSettingsProvider} and note the
 * absence of {@code @Validated}: validation is driven by the provider so that a bad value cannot
 * abort the refresh chain.
 */
@Component
